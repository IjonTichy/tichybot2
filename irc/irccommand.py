...
class IRCCommand(object):
    ...
    def __str__(self):
        ...
        if self.args and self.message: return "{} {} :{}".format(cmd, " ".join(self.args), self.message)
        elif self.args: return "{} {}".format(cmd, " ".join(self.args))
        elif self.message: return "{} :{}".format(cmd, self.message)
        else: return "{}".format(cmd)
